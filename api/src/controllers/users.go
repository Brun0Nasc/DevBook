...
func UpdatePassword(w http.ResponseWriter, r *http.Request) {
	...
	if userID != tokenUserID {
		responses.Error(w, http.StatusForbidden, errors.New("you don't have permission to update another user's password"))
	}
	...
	userPassword, err := repo.GetPassword(userID)
	if err != nil {
		responses.Error(w, http.StatusInternalServerError, err)
		return
	}

	if err = security.VerifyPassword(userPassword, password.Current); err != nil {
		responses.Error(w, http.StatusUnauthorized, errors.New("the current password is incorrect"))
		return
	}
